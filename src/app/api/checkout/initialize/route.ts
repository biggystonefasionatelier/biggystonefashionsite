...
export async function POST(request: Request) {
  ...
  try {
    ...
    // Five possible retail discount codes: the September launch promo
    ...
    // code (BSTONEWHOLESALE - 25% off a ₦10,000+ order, manually given
    // out by Faith - see src/lib/orderPricing.ts). At most one applies
    // per order.
